...
const HeaderActions: React.FC<Omit<HeaderProps, 'isLandingPage'>> = ({ 
    theme, toggleTheme, onToggleResources, onToggleWordPressConfig, onToggleApiConfig, onToggleHistory, onToggleViralVault, onToggleScheduler
}) => (
